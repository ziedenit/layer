...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r635.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r642); const ctx_r641 = ɵngcc0.ɵɵnextContext(); return ctx_r641.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r636 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r636.rows)("first", ctx_r636.first)("totalRecords", ctx_r636.totalRecords)("pageLinkSize", ctx_r636.pageLinks)("alwaysShow", ctx_r636.alwaysShowPaginator)("rowsPerPageOptions", ctx_r636.rowsPerPageOptions)("dropdownAppendTo", ctx_r636.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r636.paginatorDropdownScrollHeight)("templateLeft", ctx_r636.paginatorLeftTemplate)("templateRight", ctx_r636.paginatorRightTemplate)("currentPageReportTemplate", ctx_r636.currentPageReportTemplate)("showCurrentPageReport", ctx_r636.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowData_r643 = ctx.$implicit;
    const rowIndex_r644 = ctx.index;
    const ctx_r637 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r637.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r643, rowIndex_r644));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r638.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r647); const ctx_r646 = ɵngcc0.ɵɵnextContext(); return ctx_r646.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r639 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r639.rows)("first", ctx_r639.first)("totalRecords", ctx_r639.totalRecords)("pageLinkSize", ctx_r639.pageLinks)("alwaysShow", ctx_r639.alwaysShowPaginator)("rowsPerPageOptions", ctx_r639.rowsPerPageOptions)("dropdownAppendTo", ctx_r639.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r639.paginatorDropdownScrollHeight)("templateLeft", ctx_r639.paginatorLeftTemplate)("templateRight", ctx_r639.paginatorRightTemplate)("currentPageReportTemplate", ctx_r639.currentPageReportTemplate)("showCurrentPageReport", ctx_r639.showCurrentPageReport);
} }
