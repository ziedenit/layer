...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r168.handleValues[0] + "%", ctx_r168.handleValues[1] - ctx_r168.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r169.handleValues[0] + "%", ctx_r169.handleValues[1] - ctx_r169.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r170.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r171.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r177); const ctx_r176 = ɵngcc0.ɵɵnextContext(); return ctx_r176.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r177); const ctx_r178 = ɵngcc0.ɵɵnextContext(); return ctx_r178.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r177); const ctx_r179 = ɵngcc0.ɵɵnextContext(); return ctx_r179.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r177); const ctx_r180 = ɵngcc0.ɵɵnextContext(); return ctx_r180.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r177); const ctx_r181 = ɵngcc0.ɵɵnextContext(); return ctx_r181.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r172 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r172.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r172.orientation == "horizontal" ? ctx_r172.handleValue + "%" : null, ctx_r172.orientation == "vertical" ? ctx_r172.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r172.tabindex)("aria-valuemin", ctx_r172.min)("aria-valuenow", ctx_r172.value)("aria-valuemax", ctx_r172.max)("aria-labelledby", ctx_r172.ariaLabelledBy);
} }
const _c8 = function (a0) { return { "ui-slider-handle-active": a0 }; };
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    const _r184 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 10);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r184); const ctx_r183 = ɵngcc0.ɵɵnextContext(); return ctx_r183.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r184); const ctx_r185 = ɵngcc0.ɵɵnextContext(); return ctx_r185.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r184); const ctx_r186 = ɵngcc0.ɵɵnextContext(); return ctx_r186.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r184); const ctx_r187 = ɵngcc0.ɵɵnextContext(); return ctx_r187.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r184); const ctx_r188 = ɵngcc0.ɵɵnextContext(); return ctx_r188.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r173 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r173.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r173.rangeStartLeft, ctx_r173.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r173.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r173.tabindex)("aria-valuemin", ctx_r173.min)("aria-valuenow", ctx_r173.value ? ctx_r173.value[0] : null)("aria-valuemax", ctx_r173.max)("aria-labelledby", ctx_r173.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r191 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r191); const ctx_r190 = ɵngcc0.ɵɵnextContext(); return ctx_r190.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r191); const ctx_r192 = ɵngcc0.ɵɵnextContext(); return ctx_r192.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r191); const ctx_r193 = ɵngcc0.ɵɵnextContext(); return ctx_r193.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r191); const ctx_r194 = ɵngcc0.ɵɵnextContext(); return ctx_r194.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r191); const ctx_r195 = ɵngcc0.ɵɵnextContext(); return ctx_r195.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r174 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r174.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r174.rangeEndLeft, ctx_r174.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r174.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r174.tabindex)("aria-valuemin", ctx_r174.min)("aria-valuenow", ctx_r174.value ? ctx_r174.value[1] : null)("aria-valuemax", ctx_r174.max)("aria-labelledby", ctx_r174.ariaLabelledBy);
} }
const _c9 = function (a1, a2, a3, a4) { return { "ui-slider ui-widget ui-widget-content ui-corner-all": true, "ui-state-disabled": a1, "ui-slider-horizontal": a2, "ui-slider-vertical": a3, "ui-slider-animate": a4 }; };
